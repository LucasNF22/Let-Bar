window.onload = function () {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (inputBrand.value === "") {
            ...
            brandErrors.innerHTML = ""
            brandErrorsAcu++;
            brandErrors.innerHTML += '<li class="feedback">' + "introduci un nombre mas largo" + '</li>'
        } else {
            brandErrors.innerHTML = "";
            brandErrorsAcu = 0
        }
        ...
        if (inputGraduacion.value === "") {
            ...
            graduacionErrors.innerHTML += '<li class="feedback">' + "Debes introducir la graduacion del producto" + '</li>';
            graduacionErrorsAcu++;
        } else {
            graduacionErrors.innerHTML = "";
